...
namespace S3
{
	...
	{
		[Tooltip("Does this game mode have an inventory? Set to true if so")]
		...
		void SetInitialReferences()
		{
			...
			{
				Debug.LogWarning("Please type in th name of the button used to toggle the inventory in GameManager_ToggleInventoryUI");
				this.enabled = false;
			}
		}
