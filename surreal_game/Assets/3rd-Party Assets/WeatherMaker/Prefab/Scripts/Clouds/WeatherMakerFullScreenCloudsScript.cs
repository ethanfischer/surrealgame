...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerFullScreenCloudsScript : MonoBehaviour
    {
        ...
        [Tooltip("Whether to auto-clone the profile when it changes. Set to false to directly edit an original cloud profile. Be careful if this is false - " +
            "you can accidently overwrite changes to your cloud profile.")]
        public bool AutoCloneProfileOnChange = true;
        ...
        private void UpdateShaderProperties(WeatherMakerCommandBuffer b)
        {
            ...
            b.Material.SetInt(WMS._FogSunShaftMode, 0);
            ...
            b.Material.SetInt(WMS._FogSunShaftMode, 1);
            ...
            b.Material.SetVector(WMS._FogSunShaftsParam1, new Vector4(vol.CloudDirLightRaySpread / (float)sampleCount, (float)sampleCount, brightness, 1.0f / (float)sampleCount));
            b.Material.SetVector(WMS._FogSunShaftsParam2, new Vector4(vol.CloudDirLightRayStepMultiplier, vol.CloudDirLightRayDecay, vol.CloudDirLightRayDither, 0.0f));
            b.Material.SetVector(WMS._FogSunShaftsTintColor, new Vector4(vol.CloudDirLightRayTintColor.r * vol.CloudDirLightRayTintColor.a, vol.CloudDirLightRayTintColor.g * vol.CloudDirLightRayTintColor.a,
                vol.CloudDirLightRayTintColor.b * vol.CloudDirLightRayTintColor.a, vol.CloudDirLightRayTintColor.a));
            b.Material.SetVector(WMS._FogSunShaftsDitherMagic, new Vector4(vol.CloudDirLightRayDitherMagic.x * Screen.width, vol.CloudDirLightRayDitherMagic.y * Screen.height,
        ...
        private void DeleteAndTransitionRenderProfile(WeatherMakerCloudProfileScript newProfile)
        {
            if (newProfile != null)
            {
                if (newProfile.name.IndexOf("(Clone)") < 0 && AutoCloneProfileOnChange)
                {
            ...
            if (newProfile != null && AutoCloneProfileOnChange)
            {
        ...
        private void EnsureProfile()
        {
            ...
            else if (AutoCloneProfileOnChange && _CloudProfile.name.IndexOf("(Clone)") < 0)
            {
        ...
        public void ShowCloudsAnimated(WeatherMakerCloudProfileScript newProfile, float transitionDelay, float transitionDuration, string tweenKey = null)
        {
            ...
            if (WeatherMakerScript.Instance != null && WeatherMakerScript.Instance.PerformanceProfile != null &&
                !WeatherMakerScript.Instance.PerformanceProfile.EnableVolumetricClouds)
            {
