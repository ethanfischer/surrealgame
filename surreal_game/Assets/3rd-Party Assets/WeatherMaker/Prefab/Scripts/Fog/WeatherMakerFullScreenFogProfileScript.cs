...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerFullScreenFogProfileScript : WeatherMakerFogProfileScript
    {
        ...
        public override void UpdateMaterialProperties(Material material, Camera camera)
        {
            ...
            material.SetFloat(WMS._FogHeight, Mathf.Max(0.0f, FogHeight));
                ...
                SunShaftTintColor.a > 0.0f)
            {
                ...
                material.SetInt(WMS._FogSunShaftMode, 1);
                ...
                material.SetVector(WMS._FogSunShaftsParam1, new Vector4(SunShaftSpread / (float)SunShaftSampleCount, (float)SunShaftSampleCount, brightness, 1.0f / (float)SunShaftSampleCount));
                material.SetVector(WMS._FogSunShaftsParam2, new Vector4(SunShaftStepMultiplier, SunShaftDecay, SunShaftDither, 0.0f));
                material.SetVector(WMS._FogSunShaftsTintColor, new Vector4(SunShaftTintColor.r * SunShaftTintColor.a, SunShaftTintColor.g * SunShaftTintColor.a,
                    SunShaftTintColor.b * SunShaftTintColor.a, SunShaftTintColor.a));
                material.SetVector(WMS._FogSunShaftsDitherMagic, new Vector4(SunShaftDitherMagic.x * Screen.width , SunShaftDitherMagic.y * Screen.height, SunShaftDitherMagic.z * Screen.width, SunShaftDitherMagic.w * Screen.height));
            }
            else
            {
                // sun shafts not visible
                material.SetInt(WMS._FogSunShaftMode, 0);
            }
        }
    }
}
