...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerFullScreenFogScript : WeatherMakerFogScript<WeatherMakerFullScreenFogProfileScript>
    {
        ...
        private void UpdateFogProperties()
        {
            ...
            Shader.SetGlobalInt(WMS._FogMode, (int)FogProfile.FogMode);
            Shader.SetGlobalFloat(WMS._FogDensity, FogProfile.FogDensity);
            Shader.SetGlobalFloat(WMS._MaxFogFactor, FogProfile.MaxFogFactor);
