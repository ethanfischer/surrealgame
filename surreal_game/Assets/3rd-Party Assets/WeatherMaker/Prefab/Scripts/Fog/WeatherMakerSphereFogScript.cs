...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerSphereFogScript : WeatherMakerFogScript<WeatherMakerFogProfileScript>
    {
        ...
        protected override void LateUpdate()
        {
            ...
            pos.w = radius * radius;
            FogMaterial.SetVector(WMS._FogSpherePosition, pos);
            FogMaterial.SetVector(WMS._FogBoxCenter, pos);
            FogMaterial.SetVector(WMS._FogVolumePower, new Vector4(1.0f / pos.w, FogProfile.FogEdgeSmoothFactor, FogProfile.FogHeightFalloffPower, FogProfile.FogEdgeFalloffPower));
