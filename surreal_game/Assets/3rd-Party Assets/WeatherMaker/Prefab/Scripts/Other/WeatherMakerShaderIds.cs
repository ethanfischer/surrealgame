...
namespace DigitalRuby.WeatherMaker
{
    public static class WMS
    {
        ...
        public static readonly int _FogBoxCenter = Shader.PropertyToID("_FogBoxCenter");
        public static readonly int _FogBoxMax = Shader.PropertyToID("_FogBoxMax");
        public static readonly int _FogBoxMaxDir = Shader.PropertyToID("_FogBoxMaxDir");
        public static readonly int _FogBoxMin = Shader.PropertyToID("_FogBoxMin");
        public static readonly int _FogBoxMinDir = Shader.PropertyToID("_FogBoxMinDir");
        ...
        public static readonly int _FogDensityScatter = Shader.PropertyToID("_FogDensityScatter");
        public static readonly int _FogDitherLevel = Shader.PropertyToID("_FogDitherLevel");
        public static readonly int _FogEmissionColor = Shader.PropertyToID("_FogEmissionColor");
        public static readonly int _FogFactorMultiplier = Shader.PropertyToID("_FogFactorMultiplier");
        public static readonly int _FogHeight = Shader.PropertyToID("_FogHeight");
        public static readonly int _FogLightAbsorption = Shader.PropertyToID("_FogLightAbsorption");
        public static readonly int _FogLightShadowBrightness = Shader.PropertyToID("_FogLightShadowBrightness");
        public static readonly int _FogLightShadowDecay = Shader.PropertyToID("_FogLightShadowDecay");
        public static readonly int _FogLightShadowDither = Shader.PropertyToID("_FogLightShadowDither");
        public static readonly int _FogLightShadowDitherMagic = Shader.PropertyToID("_FogLightShadowDitherMagic");
        public static readonly int _FogLightShadowInvSampleCount = Shader.PropertyToID("_FogLightShadowInvSampleCount");
        public static readonly int _FogLightShadowMaxRayLength = Shader.PropertyToID("_FogLightShadowMaxRayLength");
        public static readonly int _FogLightShadowMultiplier = Shader.PropertyToID("_FogLightShadowMultiplier");
        public static readonly int _FogLightShadowPower = Shader.PropertyToID("_FogLightShadowPower");
        public static readonly int _FogLightShadowSampleCount = Shader.PropertyToID("_FogLightShadowSampleCount");
        public static readonly int _FogMode = Shader.PropertyToID("_FogMode");
        public static readonly int _FogNoiseAdder = Shader.PropertyToID("_FogNoiseAdder");
        public static readonly int _FogNoiseEnabled = Shader.PropertyToID("_FogNoiseEnabled");
        public static readonly int _FogNoiseMultiplier = Shader.PropertyToID("_FogNoiseMultiplier");
        public static readonly int _FogNoisePercent = Shader.PropertyToID("_FogNoisePercent");
        public static readonly int _FogNoisePositionOffset = Shader.PropertyToID("_FogNoisePositionOffset");
        public static readonly int _FogNoiseSampleCount = Shader.PropertyToID("_FogNoiseSampleCount");
        public static readonly int _FogNoiseSampleCountInverse = Shader.PropertyToID("_FogNoiseSampleCountInverse");
        public static readonly int _FogNoiseScale = Shader.PropertyToID("_FogNoiseScale");
        public static readonly int _FogNoiseVelocity = Shader.PropertyToID("_FogNoiseVelocity");
        public static readonly int _FogSpherePosition = Shader.PropertyToID("_FogSpherePosition");
        public static readonly int _FogSunShaftMode = Shader.PropertyToID("_FogSunShaftMode");
        public static readonly int _FogSunShaftsDitherMagic = Shader.PropertyToID("_FogSunShaftsDitherMagic");
        public static readonly int _FogSunShaftsParam1 = Shader.PropertyToID("_FogSunShaftsParam1");
        public static readonly int _FogSunShaftsParam2 = Shader.PropertyToID("_FogSunShaftsParam2");
        public static readonly int _FogSunShaftsTintColor = Shader.PropertyToID("_FogSunShaftsTintColor");
        public static readonly int _FogVolumePower = Shader.PropertyToID("_FogVolumePower");
        public static readonly int _FogVolumetricLightMode = Shader.PropertyToID("_FogVolumetricLightMode");
        ...
        public static readonly int _MaxFogFactor = Shader.PropertyToID("_MaxFogFactor");
