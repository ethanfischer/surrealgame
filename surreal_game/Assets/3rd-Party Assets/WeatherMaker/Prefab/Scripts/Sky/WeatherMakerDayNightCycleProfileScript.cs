...
#pragma warning restore 0414
        ...
        {
            float dot, yPower;
            float sunIntensityReducer = 1.0f - Mathf.Min(1.0f, Mathf.Pow(sun.Light.intensity, 0.2f));
        ...
        private void UpdateAmbientColors(float l)
        {
            ...
            switch (AmbientColorMode)
            {
                ...
                case WeatherMakerDayNightAmbientColorMode.AllWithUnityMode:
                    RenderSettings.ambientLight = ambientLight;
                    RenderSettings.ambientSkyColor = ambientLightSky + ambientLight;
                    RenderSettings.ambientEquatorColor = ambientLightEquator + ambientLight;
                    RenderSettings.ambientGroundColor = ambientLightGround + ambientLight;
                    Shader.SetGlobalColor(WMS._WeatherMakerAmbientLightColor, ambientLight);
                    Shader.SetGlobalColor(WMS._WeatherMakerAmbientLightColorSky, ambientLightSky + ambientLight);
                    Shader.SetGlobalColor(WMS._WeatherMakerAmbientLightColorGround, ambientLightGround + ambientLight);
                    Shader.SetGlobalColor(WMS._WeatherMakerAmbientLightColorEquator, ambientLightEquator + ambientLight);
                    break;
