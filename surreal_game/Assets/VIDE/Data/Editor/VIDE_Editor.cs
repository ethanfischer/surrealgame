...
public class VIDE_Editor : EditorWindow
{
    ...
    void OnEnable()
    {
        //EditorWindow.GetWindow<VIDE_Editor>().Close();
    ...
    void DrawToolbar2()
    {
        ...
        GUILayout.Label("VIDE 2.1.1", EditorStyles.miniLabel);
    ...
    void DrawSpyView()
    {
        ...
        {
            GUI.Label(new Rect(0, 80, 300, 64), "Please select a node.", titleStyle);
