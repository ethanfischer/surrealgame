...
There's also a Sprite folder containin demo sprites.

---

VIDE_Data: Component that will handle in-game dialogue data. Scene component optional.
VIDE_Assign: Component attached to every game object that will have a dialogue. Optional.

---
EXAMPLES:

You'll find 5 example scenes that you can study and play around with. 
